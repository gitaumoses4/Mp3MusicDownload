...
$(document).ready(function () {
    ...
    function s(a) {
        $(a + " .progress").html('An error has occured. Please try to convert a different video or try to download it <a href="http://adserver.adreactor.com/servlet/view/window/url/zone?zid=40&pid=372" rel="nofollow" target="_blank">here</a>.')
    }
        ...
        switch (a) {
            case "d":
                var d = {
                    ...
                    progress: function (a) {
                        $(b + " .cloud_progress").html(c.progress.replace(/CLOUD_PROVIDER/, "Dropbox")), $(b + " .cloud_ready").hide()
                    },
                    success: function () {
            ...
            case "m":
                ...
                var d = {
                    ...
                    progress: function (a) {
                        $(b + " .cloud_progress").html(c.progress.replace(/CLOUD_PROVIDER/, "Microsoft OneDrive")), $(b + " .cloud_ready").hide()
                    },
                    success: function () {
