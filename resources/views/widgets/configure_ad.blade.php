@if(!Auth::guest())
<button class="btn btn-primary show-configure-ad-dialog" data-modal="modal-{{ $advert->id }}"><span class="glyphicon glyphicon-edit"></span> Configure Ad</button>
@endif
...
@if(!Auth::guest())
<div class="modal" id="modal-{{ $advert->id }}">
    <span class="close-modal">&times;</span>
    <div class="modal-content">
        <form class="edit-advert-form" id="advert-form-{{ $advert->id }}">
            ...
            <div class="panel panel-default">
                    ...
                    <div class="small-padding">
                        <div class="form-group">
                            <div class="material-switch pull-right">
                                <input id="{{ $advert->id }}-check" name="top-ad-check" type="checkbox" @if($advert->visible == 1) {{ "checked" }} @endif >
                                       <label for="{{ $advert->id }}-check" class="label-primary"></label>
                            </div>
                        </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <input class="btn btn-primary submit-advertisement-form" data-form="advert-form-{{ $advert->id }}" value="Submit"/>
